...
const IncomeExpenses: React.FC = () => {
  ...
  return (
    <div className="w-96 mt-3 py-7 text-xl md:text-2xl flex justify-evenly items-center shadow-xl">
      <div className="space-y-1">
        <h3 className="uppercase">Income</h3>
        <p className="text-lg md:text-xl text-[#2ecc71]">+${income}</p>
      </div>
      <div className="border h-16 w-0"></div>
      <div className="space-y-1">
        <h3 className="uppercase">Expense</h3>
        <p className="text-lg md:text-xl text-[#c0392b]">-${expense}</p>
      </div>
    </div>
  );
};
